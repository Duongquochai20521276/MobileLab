...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.bai01.DatabaseHandler db = new DatabaseHandler(this);
        ...
        ListView lv_main = findViewById(R.id.listview_main);
        com.example.bai01.ContactAdapter adapter = new ContactAdapter(this, contacts);
